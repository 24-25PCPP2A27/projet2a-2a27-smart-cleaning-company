...
bool Services::exportToPDF(const QString &filePath) {
    ...
    // Debug: Vérifiez si la configuration de l'imprimante est correcte
    qDebug() << "Fichier PDF va être créé : " << filePath;

    // Tentative d'impression
    document.print(&printer);  // Pas de retour à vérifier
